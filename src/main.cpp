...
constexpr const wchar_t* kUsage =
    ...
    L"  Izq / Der            un fotograma atras o adelante\n"
    ...
    L"  Ctrl + rueda         ampliar sobre el punto del raton\n"
    L"  arrastrar            desplazar la imagen ampliada\n"
    L"  Z                    ajustar a la ventana\n"
    L"  X                    tamano original (1:1)\n"
    ...
    L"-clic para avanzar por la lista, clic derecho para elegir- y un boton\n"
    L"de captura. Las capturas van a Imagenes\\Pyxis a resolucion nativa.\n";
